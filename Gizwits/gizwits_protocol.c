...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    devStatusPtr->valuelatitude = exchangeBytes(gizY2XFloat(latitude_RATIO,  latitude_ADDITION, dataPoints->valuelatitude));     
    devStatusPtr->valuelongitude = exchangeBytes(gizY2XFloat(longitude_RATIO,  longitude_ADDITION, dataPoints->valuelongitude));     
