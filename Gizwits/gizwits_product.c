...
void userHandle(void)
{
    ...
    currentDataPoint.valuelatitude = latitude;   // Add Sensor Data Collection
    currentDataPoint.valuelongitude = longitude; // Add Sensor Data Collection
}
...
void userInit(void)
{
    ...
    currentDataPoint.valuelatitude = latitude;
    currentDataPoint.valuelongitude = longitude;
}
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *UartHandle)
{
    ...
    {
        atgm336h_UART_RxCpltCallback(UartHandle);
    }
}
